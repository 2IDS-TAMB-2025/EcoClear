        ...
        <div class="container-fluid position-relative p-0">
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <a href="contact2.php<?php echo $cnpj ?>" class="nav-item nav-link active">Contatos</a>
            ...
            <div class="container-fluid bg-breadcrumb">
                <div class="container text-center py-5" style="max-width: 900px;">
                    <h4 class="text-white display-4 mb-4 wow fadeInDown" data-wow-delay="0.1s">Contatos</h4>
                    <ol class="breadcrumb d-flex justify-content-center mb-0 wow fadeInDown" data-wow-delay="0.3s">
                        <li class="breadcrumb-item"><a href="index.html">Início</a></li>
                        <li class="breadcrumb-item"><a href="#">Sobre nós</a></li>
                        <li class="breadcrumb-item active text-primary">Contatos</li>
                    </ol>    
                </div>
            </div>
            <!-- Header End -->
                ...
                <div class="row g-5">
                    <div class="col-xl-6">
                        <div class="wow fadeInUp" data-wow-delay="0.2s">
                                ...
                                <div class="row g-4">
                                    <div class="col-md-6">
                                        <div class="contact-add-item">
                                            ...
                                            <div>
                                                <h4>Endereço</h4>
                                                <p class="mb-0"> Tambaú SP/13710-000</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="contact-add-item">
                                            ...
                                            <div>
                                                <h4>Email</h4>
                                                <p class="mb-0">suporteecoclear@gmail.com</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                            ...
                            <div class="bg-light p-5 rounded h-100 wow fadeInUp" data-wow-delay="0.2s">
                                ...
                                <p class="mb-4">Tem dúvidas sobre nossos serviços ou quer saber mais sobre como fazemos a diferença.<a class="text-primary fw-bold"> Envie sua mensagem por aqui. Nossa equipe está pronta para ajudar!</a></p>
                                <form action="https://formsubmit.co/suporteecoclear@gmail.com" method="POST">
                                    <div class="row g-4">
                                        ...
                                        <div class="col-12">
                                            <button class="btn btn-primary w-100 py-3">Enviar Mensagem</button>
                                            <input type="hidden" name="_next" value="http://127.0.0.1:5500/view/contact3.html">
                    ...
                    <div class="col-xl-6 wow fadeInRight" data-wow-delay="0.2s">
                        <div class="rounded h-100">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d118677.20892184759!2d-47.314485477165015!3d-21.63806039005024!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94b7ec18c2ffbc5d%3A0x93064a179e2034ad!2sTamba%C3%BA%2C%20SP%2C%2013710-000!5e0!3m2!1spt-BR!2sbr!4v1739276257480!5m2!1spt-BR!2sbr" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                        </div>
                    </div>
                </div>
            </div>
