...
(ID, TITULO, DATA_PUBLICACAO, IMAGEM, LINK, FK,ID,ADMINISTRADOR)
VALUES
('Entra em vigor lei que institui Política Nacional de Qualidade do Ar', '2024-05-03 09:32:00', 'noticia1.jpg', 'https://www.camara.leg.br/noticias/1058308-entra-em-vigor-lei-que-institui-politica-nacional-de-qualidade-do-ar/',1 ),
('O impacto da poluição industrial do ar na mortalidade no Brasil', '2025-02-04 09:55:00', 'noticia2.jpg', 'https://www.nexojornal.com.br/externo/2025/02/03/o-impacto-da-poluicao-industrial-do-ar-na-mortalidade-no-brasil', 2),
('Estudo reconstrói um século de poluição na cidade de São Paulo', '2025-04-12 08:00:00', 'noticia3.jpg', 'https://www.cnnbrasil.com.br/noticias/estudo-reconstroi-um-seculo-de-poluicao-na-cidade-de-sao-paulo/',3),
('As cidades brasileiras mais sufocadas: Ranking da poluição do ar', '2024-11-09 14:03:00', 'noticia4.jpg', 'https://www.tupi.fm/entretenimento/as-cidades-brasileiras-mais-sufocadas-ranking-da-poluicao-do-ar/',4),
('Painel vai monitorar poluição atmosférica e impactos na saúde humana', '2024-06-27 15:55:00', 'noticia5.jpg', 'https://agenciabrasil.ebc.com.br/saude/noticia/2024-06/painel-vai-monitorar-poluicao-atmosferica-e-impactos-na-saude-humana',5),
('Córrego na Argentina ganha cor vermelha e gera suspeitas de poluição industrial', '2025-02-07 21:00:00', 'noticia6.jpg', 'https://www.meon.com.br/noticias/mundo/corrego-em-avellaneda-argentina-ganha-cor-vermelha-e-gera-suspeitas-de-poluicao-industrial',6),
('A primeira poluição "industrial" do mundo: como a Grécia Antiga liberou chumbo no meio ambiente', '2025-02-02 13:20:00', 'noticia7.jpg', 'https://umsoplaneta.globo.com/sociedade/noticia/2025/02/02/a-primeira-poluicao-industrial-do-mundo-como-a-grecia-antiga-liberou-chumbo-no-meio-ambiente.ghtml',7),
('Dia do Combate à Poluição: como a química ajuda na preservação ambiental?', '2025-03-11', 'noticia8.jpg', 'https://www.educamaisbrasil.com.br/educacao/noticias/dia-do-combate-a-poluicao-como-a-quimica-ajuda-na-preservacao-ambiental',8),
('Brasil é 4º no mundo em ranking de emissão de gases poluentes desde 1850', '2021-10-27 00:00:00', 'noticia9.jpg', 'https://www.bbc.com/portuguese/geral-59065359',9),
('Cetesb pede ajuda às indústrias para reduzir poluição em Cubatão', '2024-03-19 10:43:00', 'noticia10.jpg', 'https://www.diariodolitoral.com.br/cotidiano/cetesb-pede-ajuda-as-industrias-para-reduzir-poluicao-em-cubatao/180175/',10);
...
VALUES
('AQ-01','Sensor de Gás','São Paulo - SP','Ativo','PPM', '48956372000161'),
('AQ-02','Sensor de Temperatura','Rio de Janeiro - RJ','Inativo','ºC','73182045000132'),
('AQ-03','Sensor de Gás','Belo Horizonte - MG','Manutenção','PPM','14259736000120'),
('AQ-04','Sensor de Temperatura','Curitiba - PR','Ativo','ºC','67425183000147'),
('AQ-05','Sensor de Gás','Porto Alegre - RS','Inativo','PPM','90813452000105'),
('AQ-06','Sensor de Temperatura','Brasília - DF','Ativo','ºC','32547896000192');

INSERT INTO DADO_SENSOR
(DADO, DATA_HORA, FK_ID_SENSOR)
VALUES
('410','2025-06-02 10:00:00',1),
('22','2025-05-28 13:30:00',2),
('456','2025-04-30 16:50:00',3),
('26.5','2025-06-03 21:20:00',4),
('444','2025-05-17 12:20:00',5),
('24.8','2025-05-04 09:25:00',6);
...
SELECT * FROM NOTIFICACAO WHERE ID=4;
SELECT * FROM NOTIFICACAO WHERE CONTEUDO='A promoção de verão está ativa, aproveite as ofertas.';
SELECT * FROM NOTIFICACAO WHERE DATA_HORA='2025-03-16 09:00:00';
SELECT * FROM NOTIFICACAO WHERE TITULO='Feriado Nacional';
SELECT * FROM NOTIFICACAO WHERE FK_CNPJ_EMPRESA='81324675000189';
SELECT * FROM NOTIFICACAO WHERE CONTEUDO='Mudança nas políticas internas de vendas.';
SELECT * FROM NOTIFICACAO WHERE DATA_HORA='2025-03-11 17:00:00';
SELECT * FROM NOTIFICACAO WHERE TITULO='Campanha de Marketing Primavera';
SELECT * FROM NOTIFICACAO WHERE ID=9;
...
/*SELECT COM INTEGRAÇÃO DE TABELA*/
SELECT 	N.TITULO,
		A.NOME
FROM	NOTICIAS N
INNER JOIN ADMINISTRADOR A 
ON (N.FK_ID_ADMINISTRADOR = A.ID);

SELECT 	N.LINK,
		A.EMAIL
FROM	NOTICIAS N
INNER JOIN ADMINISTRADOR A ON (N.FK_ID_ADMINISTRADOR = A.ID);

SELECT	N.DATA_PUBLICACAO,
		A.CELULAR
FROM	NOTICIAS N
INNER JOIN ADMINISTRADOR A ON (N.FK_ID_ADMINISTRADOR = A.ID);
...
SELECT 	S.NOME,
		...
		E.CNPJ
FROM    SENSOR S
INNER JOIN EMPRESA E ON (S.FK_CNPJ_EMPRESA = E.CNPJ);
...
SELECT	S.LOCALIZACAO,
		E.BAIRRO
FROM	SENSOR S
INNER JOIN EMPRESA E ON (S.FK_CNPJ_EMPRESA = E.CNPJ);

SELECT	S.STATUS_SENSOR,
		E.EMAIL
FROM	SENSOR S
INNER JOIN EMPRESA E ON (S.FK_CNPJ_EMPRESA = E.CNPJ);
...
SELECT	N.TITULO,
        ...
        E.EMAIL
FROM	NOTIFICACAO N
INNER JOIN EMPRESA E ON(N.FK_CNPJ_EMPRESA = E.CNPJ);
