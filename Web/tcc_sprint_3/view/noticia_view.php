...
<html lang="pt-br">
        ...
        <div class="container-fluid position-relative p-0">
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <a href="../view/cadastro_login.php" class="btn btn-primary rounded-pill py-2 px-4 my-3 my-lg-0 flex-shrink-0">Login</a>
                </div>
            </nav>
    ...
    ?>
    <div class="blog-item p-4" style="min-height: 480px">
        ...
        <a href="<?php echo $noticia["LINK"];?>" class="h4 d-inline-block mb-3" target="_blank">
                ...
                <div class="row g-5">
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-2">
                        <div class="footer-item">
                            ...
                            <a href="noticia_view.php" class="text-white mb-0"><i class="fas fa-angle-right me-2"></i> Notícias</a>
