...
<html lang="pt-br">
    ...
    <head>
        ...
        (function(){
            emailjs.init("m34sMlzOzZ_Z3h-Yi");
        })();
        </script>
    ...
    <body>
                                    ...
                                    <div class="row g-4">
                                        <div class="col-lg-12 col-xl-6">
                                            <div class="form-floating">
                                                <input type="text" class="form-control border-0" id="name" name="name" placeholder="Nome completo" required>
                                                <label for="name">Nome Completo</label>
                                            </div>
                                        </div>
                                        <div class="col-lg-12 col-xl-6">
                                            <div class="form-floating">
                                                <input type="email" class="form-control border-0" id="email" name="email" placeholder="Seu Email" required>
                                                <label for="email">Email</label>
                                            </div>
                                        </div>
                                        <div class="col-lg-12 col-xl-6">
                                            <div class="form-floating">
                                                <input type="text" class="form-control border-0" id="phone" name="phone" placeholder="Telefone">
                                                <label for="phone">Telefone</label>
                                            </div>
                                        </div>
                                        <div class="col-lg-12 col-xl-6">
                                            <div class="form-floating">
                                                <input type="text" class="form-control border-0" id="subject" name="subject" placeholder="Assunto" required>
                                                <label for="subject">Assunto</label>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-floating">
                                                <textarea class="form-control border-0" id="message" name="message" placeholder="Mensagem" style="height:160px" required></textarea>
                                                <label for="message">Mensagem</label>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <button type="submit" class="btn btn-primary w-100 py-3">Enviar Mensagem</button>
                                        </div>
                                    </div>
                                </form>
                                <div id="formResult" style="margin-top:10px; text-align:center;"></div>
                            </div>
                        </div>
                    </div>
        ...
        document.getElementById('contactForm').addEventListener('submit', function(event){
            ...
            const serviceID = 'service_ecoclear';
            const templateID = 'template_ecoclear_contat';

            emailjs.sendForm(serviceID, templateID, this)
            .then(() => {
                document.getElementById('formResult').innerHTML = '<span style="color:green;">Mensagem enviada com sucesso!</span>';
                document.getElementById('contactForm').reset();
            }, (err) => {
                document.getElementById('formResult').innerHTML = '<span style="color:red;">Erro ao enviar a mensagem. Tente novamente!</span>';
